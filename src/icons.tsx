...
export const CssIcon = createIcon("CssIcon", <><path d="M5 3.5h14l-1.2 13.8L12 20.5l-5.8-3.2L5 3.5Z" /><path d="M8.3 7.2h7.4l-.35 3.15H8.75l.25 3.2 3 1.55 3-1.55.22-2.05" /><path d="M9.2 17.9h5.6" /><circle cx="12" cy="10.35" r=".85" /></>);
...
export const ReactIcon = createIcon("ReactIcon", <><circle cx="12" cy="12" r="1.85" /><ellipse cx="12" cy="12" rx="8.4" ry="3.4" /><ellipse cx="12" cy="12" rx="8.4" ry="3.4" transform="rotate(60 12 12)" /><ellipse cx="12" cy="12" rx="8.4" ry="3.4" transform="rotate(120 12 12)" /><path d="M7.8 12h8.4" /></>);
...
export const ShieldIcon = createIcon("ShieldIcon", <><path d="M12 3 20 6.3v5.1c0 4.9-3.1 7.8-8 9.6-4.9-1.8-8-4.7-8-9.6V6.3L12 3Z" /><path d="M8.2 11.8 11 14.6l5-6" /><path d="M8.5 6.9h7" /><circle cx="12" cy="12" r=".9" /></>);
