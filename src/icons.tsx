...
function createIcon(displayName: string, body: IconBody) {
  const Icon = React.forwardRef<SVGSVGElement, IconProps>(
    ({ size = "md", title, className, children, ...props }, ref) => {
      ...
      return (
        <svg ref={ref} className={["ax-icon", className].filter(Boolean).join(" ")} data-size={size} viewBox="0 0 24 24" fill="none" aria-hidden={title ? undefined : true} aria-labelledby={titleId} {...props}>
...
export const CardIcon = createIcon("CardIcon", <><path d="M3.5 5.5h17v13h-17v-13Z" {...plate} /><rect x="3.5" y="5.5" width="17" height="13" rx="2" /><path d="M6.5 9h11" /><path d="M6.5 13h6" /><circle cx="17" cy="14.5" r="1.15" fill="currentColor" stroke="none" /></>);
...
export const DonateIcon = createIcon("DonateIcon", <><path d="M12 21s-7.5-4.4-8.7-10.2C2.6 7.3 4.7 5 7.5 5c1.7 0 3.2.9 4.5 2.5C13.3 5.9 14.8 5 16.5 5c2.8 0 4.9 2.3 4.2 5.8C19.5 16.6 12 21 12 21Z" {...plateStrong} /><path d="M12 21s-7.5-4.4-8.7-10.2C2.6 7.3 4.7 5 7.5 5c1.7 0 3.2.9 4.5 2.5C13.3 5.9 14.8 5 16.5 5c2.8 0 4.9 2.3 4.2 5.8C19.5 16.6 12 21 12 21Z" /><circle cx="12" cy="11.5" r="1.15" fill="currentColor" stroke="none" /></>);
...
export const FormIcon = createIcon("FormIcon", <><path d="M5 3.5h14v17H5v-17Z" {...plate} /><rect x="5" y="3.5" width="14" height="17" rx="2" /><path d="M8 7.5h8" /><path d="M8 11.5h8" /><path d="M8 15.5h5" /><circle cx="16" cy="15.5" r="1" fill="currentColor" stroke="none" /></>);
...
export const PreviewIcon = createIcon("PreviewIcon", <><path d="M3 12s3.3-6 9-6 9 6 9 6-3.3 6-9 6-9-6-9-6Z" {...plate} /><path d="M3 12s3.3-6 9-6 9 6 9 6-3.3 6-9 6-9-6-9-6Z" /><circle cx="12" cy="12" r="2.7" /><circle cx="12" cy="12" r="1" fill="currentColor" stroke="none" /></>);
...
export const ServerIcon = createIcon("ServerIcon", <><path d="M4 4h16v6H4V4Z" {...plateStrong} /><path d="M4 14h16v6H4v-6Z" {...plate} /><rect x="4" y="4" width="16" height="6" rx="1.5" /><rect x="4" y="14" width="16" height="6" rx="1.5" /><circle cx="7" cy="7" r=".8" fill="currentColor" stroke="none" /><circle cx="7" cy="17" r=".8" fill="currentColor" stroke="none" /><path d="M10 7h6" /><path d="M10 17h6" /></>);
export const ClientIcon = createIcon("ClientIcon", <><path d="M4 5h16v11H4V5Z" {...plate} /><rect x="4" y="5" width="16" height="11" rx="2" /><path d="M9 20h6" /><path d="M12 16v4" /><circle cx="12" cy="10.5" r="1.2" fill="currentColor" stroke="none" /></>);
...
export const ThemeIcon = createIcon("ThemeIcon", <><path d="M12 3.2a8.8 8.8 0 1 0 0 17.6V3.2Z" {...plateStrong} /><circle cx="12" cy="12" r="8.8" /><path d="M12 3.2v17.6" /><circle cx="12" cy="12" r="1.15" fill="currentColor" stroke="none" /></>);
